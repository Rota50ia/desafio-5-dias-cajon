  ...
  <section className="py-16 md:py-24 bg-muted">
    <div className="container max-w-4xl">
      ...
      <motion.div
        ...
        className="bg-card card-glow rounded-2xl p-8 border border-border flex flex-col md:flex-row gap-8 items-center md:items-start"
      >
        {/* Foto do professor */}
        <div className="shrink-0">
          <img
            ...
            className="w-48 h-56 md:w-52 md:h-60 object-cover rounded-2xl border border-primary/20"
          />
        </div>
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex gap-4 mb-6 justify-center md:justify-start">
            <div className="bg-primary/10 border border-primary/20 rounded-xl px-5 py-3 text-center">
          ...
          <p className="text-foreground text-lg font-semibold leading-relaxed mb-8">
            O que importa é: você vai tocar ou não?
          </p>
          ...
          <a
            ...
            className="inline-block bg-primary text-primary-foreground font-heading font-semibold text-sm px-6 py-3 rounded-lg shadow-cta hover:bg-primary-dark transition-all uppercase"
          >
